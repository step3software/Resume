  ...
  <div class="container">
    ...
    <div class="section">
      <div class="headline">
        ...
        <div class="time">September 2020 – present</div>
      </div>
      <div class="indent">
        <div>Individually responsible for the full product cycle with clients</div>
      </div>
    </div>
    <div class="client section">
      <div class="headline">
    ...
    <div class="client section">
      ...
      <div class="indent">
        <div class="project">The valuation product control (VPC) adjustments application is used by Bank of
    ...
    <div class="section" style="padding-top:1rem">
      ...
      <div class="indent">
        <div class="responsibility">implemented simple solution in Visual Basic 2005</div>
      </div>
    </div>
    <div class="section">
      <div class="headline">
      ...
      <div class="indent">
        <div class="responsibility">Acquired skills in leadership and inter-cultural communication</div>
      </div>
    </div>
